-- Phase 7: Auth.js models + tenant scoping.
-- Dev migration: existing Application/StageEvent/ResumeProfile rows are removed
-- (no users exist yet to assign ownership).
